                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(
                        ...
                        style: !widget.viewModel.deviceConnected?
                        ButtonStyle(
                          backgroundColor: MaterialStatePropertyAll(highlight)
                        ):
                            ButtonStyle(
                              backgroundColor: MaterialStatePropertyAll(highlight.withOpacity(0.4))
                            )
                      ),
                      ElevatedButton(
                        onPressed: widget.viewModel.deviceConnected
                        ...
                        ButtonStyle(
                            backgroundColor: MaterialStatePropertyAll(highlight.withOpacity(0.6))
                        ),
...
class _ServiceDiscoveryListState extends State<_ServiceDiscoveryList> {
  ...
  List<ExpansionPanel> buildPanels(BuildContext c2) {
