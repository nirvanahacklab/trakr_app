...
import 'package:flutter_reactive_ble_example/src/splashScreen.dart';
...
const _themeColor =  Color(0xff222222);
  ...
  runApp(
    MultiProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          colorScheme: ColorScheme.fromSwatch().copyWith(primary: _themeColor, secondary: Colors.white),
        ),
